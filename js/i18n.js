const translations = {
  pt: {
    ...
    "about.p2.mid": ", onde construo e mantenho bibliotecas open source, extensões para VS Code, templates de CI/CD e ferramentas para desenvolvedores que já acumulam mais de",
    ...
    "project.tooark.desc.mid": "pacotes NuGet, extensões VS Code, templates CI/CD, libs e mais.",
    "project.net.tag": "Biblioteca",
    "project.net.desc": "Coleção de pacotes C# com validações, notificações, value objects, DTOs, entidades, utilitários e mais.",
    ...
    "sponsor.paypal.desc": "Doe com PayPal. Rápido, seguro e aceito em todo o mundo.",
  ...
  en: {
    ...
    "about.p2.mid": ", where I build and maintain open source libraries, VS Code extensions, CI/CD templates and developer tools with over",
    "about.p2.end": "downloads",
    ...
    "project.tooark.desc.mid": "NuGet packages, VS Code extensions, CI/CD templates, libs and more.",
    "project.net.tag": "Library",
    "project.net.desc": "Collection of C# packages with validations, notifications, value objects, DTOs, entities, utilities and more.",
    "project.net.downloads": "downloads.",
    ...
    "sponsor.paypal.desc": "Donate via PayPal. Fast, secure and accepted worldwide.",
...
function toggleLang () { setLang(currentLang === "pt" ? "en" : "pt"); }
document.querySelectorAll(".lang-switch__btn").forEach((btn) => {
